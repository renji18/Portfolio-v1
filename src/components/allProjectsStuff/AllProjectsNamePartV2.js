...
const AllProjectsNamePartV2 = ({ item }) => {
  return (
    <div className="md:flex hidden md:flex-col gap-10 justify-center items-center md:w-2/5 mt-5 md:mt-0">
...
export default AllProjectsNamePartV2;
